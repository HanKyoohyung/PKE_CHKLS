...
//Some Useful Functions for PKEKey.cpp//
//1. mod function
...
//4. return x mod y for x in [-y/2, y/2)//
...
//5. Hash function (Keccak): input 1600-bit, output 1600-bit
